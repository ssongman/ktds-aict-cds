...
## 8) **CSP의 Global/Regional/Zonal 서비스 개념 이해**
- **내용:** CSP 서비스의 글로벌, 리전, 존 구분과 특징
- **링크:** https://learn.microsoft.com/en-us/azure/reliability/regions-nonregional-services
- **Key:** 서비스 배포 범위 및 가용성 특성  



## 9) **각 Azure 자원의 가용성 구성의 특징**
- **내용:** Availability Set, Load Balancer, VPN Gateway의 가용성 구조 이해
- **링크:**
  - https://learn.microsoft.com/en-us/azure/virtual-machines/availability-set-overview
  - https://learn.microsoft.com/en-us/azure/reliability/reliability-load-balancer?toc=%2Fazure%2Fload-balancer%2Ftoc.json&bc=%2Fazure%2Fload-balancer%2Fbreadcrumb%2Ftoc.json
  - https://learn.microsoft.com/ko-kr/azure/vpn-gateway/vpn-gateway-about-vpngateways
- **Key:** 자원별 고가용성 설계 요소  
...
## 10) **Azure Storage Account(Object Storage) Tier 별 특성**
...
## 11) **Azure Storage Account Life Cycle Event 활용법**
...
## 12) **Azure Storage Account 특징과 차이**
...
## 13) **용도에 따른 Azure Storage Account 선택**
...
## 14) **RAG를 위한 저장소/DBMS Azure 서비스 선택**
...
## 16) **PV/PVC with Azure File 네트워크 설정**
...
## 19) **PaaS DBMS의 특성 이해**
- **내용:** Azure Managed Instance 등 PaaS DBMS의 특성 및 장점 이해
- **링크:** https://learn.microsoft.com/en-us/azure/azure-sql/managed-instance/sql-managed-instance-paas-overview?view=azuresql
- **Key:** 자동 백업, 고가용성, 유지관리 자동화  



# 3. 네트워크 & 보안

## 20) **VNet 구성시 Inbound(LB), Outbound(NAT) 구성방법과 흐름 이해**
...
## 26) **Azure Resource Network 접근 제어 및 Private 구성**
- **내용:** Private Endpoint 기반 네트워크 접근 제어
- **링크:**
...
## 27) **AKS Monitoring를 활용한 자원/Workload 모니터링 이해**
...
## 31) **AKS PV/PVC 사용법 및 Azure Files 특성**
...
## 34) **Container 기본 개념 및 Dockerfile 이해**
- **내용:** 이미지 슬림화 및 빌드 최적화
- **링크:** (없음)
- **Key:** 효율적 컨테이너 이미지 작성  
...
## 43) **CICD Pipeline 구성 시 Credential 관리 주의 사항**
...
## 46) **Azure Monitoring 서비스 활용 시 비용 관리**
